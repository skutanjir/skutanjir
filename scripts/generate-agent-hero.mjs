...
const profileLines = [
  { type: "header", value: "sulistyo@devlab" },
  { type: "row", key: "Subject", value: "Sulistyo Fajar Pratama" },
  { type: "row", key: "Role", value: "Fullstack & Mobile Developer" },
  { type: "row", key: "Base", value: "East Java, Indonesia" },
  { type: "row", key: "Status", value: "Coding / Shipping / Debugging at 3am" },
  { type: "blank" },
  { type: "section", value: "STACK.NODE" },
  { type: "row", key: "Frontend", value: "Vue / React / Next.js" },
  { type: "row", key: "Mobile", value: "Flutter / Kotlin" },
  { type: "row", key: "Backend", value: "Laravel / Node.js / PHP" },
  { type: "blank" },
...
<title id="title">Sulistyo Fajar Pratama - Fullstack and Mobile Developer</title>
...
<text x="${titleCenter}" y="${titlebar.y + titlebar.height / 2 + 5}" text-anchor="middle" class="terminal-label">sulistyo@devlab ~ % ./profile --live</text>
